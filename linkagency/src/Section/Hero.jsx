...
function Hero() {
  return (
   ...
   <h1 className='text-green-600 font-bold text-6x1'>Unlock the Potential of Your Digital World With Our</h1>
   <p className='text-slate-90 text-2xl'>Unlock your online potential with our exceptional team of content experts, design maestros, and development gurus. Committed to elevating your business and expanding your online reach, we are here to make your dreams a reality.</p>
